module.exports = {
    siteUrl: `https://boring-brattain-531e2f.netlify.app`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `Paulster`, // Used for App manifest e.g. Mobile Home Screen
